...
from controllers.tournament_controllers.round_controller import (
    manage_current_round, show_leaderboard
    )
from controllers.tournament_controllers.round_controller import (
    show_round_history, show_players_alphabetic
    )

UNFINISHED_TOURNAMENT_MENU = {
    "1": {"text": "Manage current round",
          "key": "1", "action": manage_current_round},
    "2": {"text": "Show leaderboard",
          "key": "2", "action": show_leaderboard},
    "3": {"text": "List all players alphabetically",
          "key": "3", "action": show_players_alphabetic},
    "4": {"text": "Show round history",
          "key": "4", "action": show_round_history},
...
def ongoing_tournament_menu(chosen_tournament):
    ...
    choice_text = UNFINISHED_TOURNAMENT_MENU[choice]["text"]
